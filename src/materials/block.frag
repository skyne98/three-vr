...
uniform usampler2D uLightingData;// rgba, unsigned byte, { vec3 vPos0 ... vec3 vPos3, vec3 vColor0 ... vec3 vColor3 }
...
uint getSamplerData(uint pixelIndex,usampler2D data,uint dataSize){
